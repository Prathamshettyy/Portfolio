# Interactive Portfolio with AI Persona Chatbot
...
- **AI-Powered Chatbot** that represents the portfolio owner
- **Responsive Design** that works on all devices
- **Project Showcase** with detailed information and links
- **Skills Section** with categorized technical abilities
- **Video Introduction** for a personal touch
