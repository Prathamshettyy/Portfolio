...
export default function Contact() {
  // Hardcoded details
  const myDetails = {
    email: "venug0430@gmail.com",
    phone: "+91 9449101008",
    github: "https://github.com/venugopala08",
    linkedin: "https://www.linkedin.com/in/venugopala-6b263226a/"
  };
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            ...
            >
              ...
              <div className="text-left">
                ...
                <span className="text-lg font-bold text-gray-900 dark:text-gray-100 break-all">{myDetails.email}</span>
              </div>
            </motion.a>
            ...
            >
              ...
              <div className="text-left">
                ...
                <span className="text-lg font-bold text-gray-900 dark:text-gray-100 break-all">{myDetails.phone}</span>
              </div>
            </motion.a>
          </div>
